...
int ValorVelocidadeMotorLadoEsquerdo = 230;
int ValorVelocidadeMotorLadoDireito = 210;
...
// Código adaptado de https://professormarlonnardi.blogspot.com/p/universo-robos-1-como-fazer-um-robo-que.html // 
